...
export default function Home() {
  const [streamName, setStreamerName] = React.useState("wtcn");
  ...
  // İkinci effect: Pusher bağlantısını kur (sadece chatRoomId hazır olduğunda)
  React.useEffect(() => {
    if (!chatRoomId) return; // chatRoomId yoksa çalışma
  ...
  }, [chatRoomId]); // chatRoomId değiştiğinde çalış
